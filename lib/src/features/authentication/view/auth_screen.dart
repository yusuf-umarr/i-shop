...
import 'package:i_shop/src/widgets/custom_button.dart';
...
class _AuthScreenState extends State<AuthScreen> {
  ...
  Widget build(BuildContext context) {
    var privider = Provider.of<AuthViewModel>(context, listen: false);
    return Scaffold(
                          ...
                          CustomButton(
                            ...
                            onTap: () async {
                              if (_signUpFormKey.currentState!.validate()) {
                                ...
                                // privider.setLoading(true);

                                await privider.register(model, context);
                              }
                            },
                          )
                        ],
                      ...
                      child: Column(
                        children: [
                          ...
                          CustomButton(
                            text: 'Sign In',
                            onTap: () async {
                              // var privider = Provider.of<AuthViewModel>(context,
                              //     listen: false);
